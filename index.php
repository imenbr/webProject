      ...
      <div class="heading wow fadeInUp" data-wow-duration="1000ms" data-wow-delay="300ms">
        <div class="row">
          <div class="text-center col-sm-8 col-sm-offset-2">
            <h2>Our Services</h2>
            <p>DecoService is an interior design service that connects you with top designers to transform your space for a low, flat fee</p>
            <p class="animated fadeInRightBig"> LET US HELP YOU WHEN... </p>
          </div>
        </div> 
      </div>
